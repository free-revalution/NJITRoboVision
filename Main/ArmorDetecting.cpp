...
{
    //Set armor detector prop //设置装甲探测模型
    detector.loadSVM(JL_Modle_Run);

    //Set angle solver prop //调用设置文件
    //相机设置
    //all_setting->writeOtherParam(PARAM_OTHER_PATH);

    //判断装甲板
    angleSolver.setCameraParam_JL(JL_CAMERA_SET, 1);
    ...
    do
    {
        ...
        detector.setEnemyColor(ENEMYCOLOR); //here set enemy color //设置敌方装甲板颜色
